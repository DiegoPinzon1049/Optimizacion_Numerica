...
# ╔═╡ 76e7b3e0-3ca9-11ee-39b6-5bc9b2c5c381
using DelimitedFiles, LinearAlgebra, Statistics, Plots, Convex, SCS

# ╔═╡ 4818468b-e3f7-4f13-b39f-54ea774ae2fe
begin
	s = "Diego Fernando Pinzón López \nUniversidad Nacional de Colombia\nFacultad de Ciencias \nMaestría en Ciencias - Matemática Aplicada
	"
	Text(s)
end

# ╔═╡ f52b3e85-46e5-425c-bf49-9a371f09fd99
md"## Lasso, Ridge and Elastic Net Regressions"

# ╔═╡ 7e4fedc7-07d0-488d-b26b-ed3ecc570c0d
md"This notebook presents a simple implementation of Lasso and elastic net regressions."

# ╔═╡ b4e5de37-2342-4357-ba5c-50b211f1567a
md"### Load Packages and Extra Functions"

# ╔═╡ b38991b0-9071-4ad0-b15d-315bc9cbf2d4
md"## Loading Data"

# ╔═╡ cc7a102f-29ed-4942-9d6d-93fe86bfa5a5
md"We use the diabetes data from Efron et al, downloaded from https://web.stanford.edu/~hastie/StatLearnSparsity_files/DATA/diabetes.html and then converted from a tab to a comma delimited file.
...
# ╔═╡ d5ac3965-8e5f-4b2b-96e7-d18cb18a81fc
begin
	(x, header) = readdlm("base.txt", '\t', header = true)
	#display(header)
	#display(x)
...
# ╔═╡ c45dce32-a046-4179-ae1b-904daf841933
md"## Lasso, Ridge and Elastic Net Regressions"

# ╔═╡ 683ea7d1-4ae0-4da6-a396-96fe98f3d384
md"""
...
# ╔═╡ dc5ab1b4-0420-4686-9b3f-a166393f22b5
"""
    LassoEN(Y,X,γ,λ)
...
# ╔═╡ 0ae0e733-5712-4918-ab0d-cf51b0cb7b37
md" The next cell makes a Lasso regression for a single value of γ."

# ╔═╡ 333cbb62-1c12-4c3a-a784-37326fba511a
begin
	K = size(X, 2)
	γ = 0.25
...
# ╔═╡ 265b1853-d8be-4135-950b-623ee4df03e6
md"### Redo the Lasso Regression with Different Gamma Values"

# ╔═╡ 1f98875a-ee92-4dd4-b82e-7a5ba77b5e0b
md" We now loop over $\gamma$ values.

Remark: it would be quicker to put this loop inside the `LassoEN()` function so as to not recreate `L1`-`L4`."

# ╔═╡ 7503458b-11c9-4320-986b-d19f609913f0
begin
	nγ = 101
...
# ╔═╡ 18df0aa6-e02c-4603-9e98-41faee347739
plot(
    log10.(γM),
    bLasso',
...
# ╔═╡ 6f12ecc5-6221-443f-b88c-32fe4fe2563a
md" ## Ridge Regression"

# ╔═╡ b3ccf4df-ab3d-4972-8f2b-7da702c89f87
md" We use the same function to do a ridge regression. Alternatively, do `b = inv(X'X/T + λ*I)*X'Y/T`."

# ╔═╡ fcd239f7-44ec-4cbe-a24f-df237a17de72
begin
	nλ = 101
...
# ╔═╡ b29b8fe5-8b1c-47d4-a7f2-62d8dbd83503
plot(
    log10.(λM),
    bRidge',
...
# ╔═╡ ea81c72c-05da-4bb6-bce2-76275f1b5107
md" ## Elastic Net Regression"

# ╔═╡ f54d03a5-ba55-4cb9-83d7-17ad4292e0da
begin
	λ = 0.5
...
# ╔═╡ 01b7d57a-aa91-4cd4-90e3-bb7649c63163
plot(
    log10.(γM),
    bEN',
